...
const Bot = () => {
  ...
  return (
    <div className="flex h-screen antialiased text-gray-800 mt-4 pb-10">
              ...
              <div className="flex-grow ml-4">
                <div className="flex w-full">
                  <input
                    ...
                    className="flex w-[80px] border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10 mr-4"
                  />
                  <input
                    type="text"
                    name={message}
